...
#ifndef BLESCANNER_SWIFT_H
#define BLESCANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BLEScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10BLEScanner19BLEScannerViewModel")
@interface BLEScannerViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CBPeripheral;
@interface BLEScannerViewModel (SWIFT_EXTENSION(BLEScanner)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BLEScannerViewModel (SWIFT_EXTENSION(BLEScanner)) <CBCentralManagerDelegate>
